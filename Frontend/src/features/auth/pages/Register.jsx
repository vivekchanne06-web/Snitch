        ...
        >
          ...
          <div className="bg-white rounded-2xl shadow-[0_2px_24px_rgba(61,57,41,0.08)] border border-[#DAD9D4]/60 p-8 sm:p-10">
            ...
            <div className="mb-8">
              ...
              >
                Join our marketplace and start shopping or selling today.
              </motion.p>
            </div>
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-5">
              ...
              <motion.div
                ...
                initial="initial"
                animate="animate"
                className="px-4 py-3.5 rounded-xl border border-[#DAD9D4] bg-[#FAF9F5] hover:border-[#A95A3A]/30 hover:bg-[#F5F4EF] transition-colors duration-200"
              >
                <SellerCheckbox
