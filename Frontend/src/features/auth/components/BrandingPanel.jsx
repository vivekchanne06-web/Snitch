...
/**
 * BrandingPanel — Left-side editorial fashion hero panel.
 *
 * Design System: Luxury fashion aesthetic — Zara / COS / Massimo Dutti.
 * Full-height fashion photograph with a subtle dark overlay, editorial
 * typography positioned at the bottom-left. No cards, no stats, no widgets.
    ...
    <div className="relative w-full h-full min-h-screen overflow-hidden">
      ...
      >
        ...
        <motion.p
          ...
          style={{ fontFamily: "'Outfit', sans-serif" }}
        >
          Discover timeless essentials and statement pieces designed for modern
          living. Shop premium collections or launch your own fashion store.
        </motion.p>
        ...
        >
          ...
          <button
            type="button"
            className="inline-flex items-center gap-2 px-6 py-3 text-sm font-medium tracking-wide text-white/85 border border-white/30 hover:bg-white/10 hover:border-white/50 hover:text-white transition-all duration-300"
