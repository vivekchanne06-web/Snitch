...
/* ══════════════════════════════════════════════════════════════════
   1. NAVBAR — 72px Fixed Height, Reused from ProductDetail.jsx
   ══════════════════════════════════════════════════════════════════ */
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
        ...
        {/* Subtle Back to Products action */}
        <button
        ...
        >
          <ArrowLeft size={14} />
          {!isMobile && <span>Back to Products</span>}
        </button>
      </div>

      {/* Navigation — Collections / Seller Portal */}
      {!isMobile && (
...
const SellerProductDetail = () => {
  ...
  return (
    ...
    >
      ...
      <main style={{ paddingTop: "72px", paddingBottom: "64px" }}>
        <AnimatePresence mode="wait">
          {/* Loading Skeleton */}
          {loading && (
